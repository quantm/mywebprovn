...
function web(){
$header = new header();
$header->index("Học lập trình","/book/index","");
...
$content=str_replace('cert/default.asp','website/web_validate.asp',$content);
$content=str_replace('#555555','#EBEB29',$content);
$content=str_replace('href','data-href',$content);
preg_match_all('/<div id="page">(.*?)<div style="clear:both;">/s',$content,$matches,PREG_SET_ORDER);
foreach($matches as $key_left);
$data['left_col']=$key_left[0];
$data['csrf_test_name'] = $this->security->get_csrf_hash(); 
$this->load->view('lap_trinh/web',$data);
}
