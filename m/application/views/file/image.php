...
<form  name=frmUpload enctype="multipart/form-data" action="/file/save" method="post" target="tftemp<?php echo $idObject?>">
	<input type="hidden" name="MAX_FILE_SIZE" value="100000000" />
        <table id='table' width=100% class="admintable" border=0>
		<tr>
			<td nowrap class=key>Chọn file ảnh cho thực đơn</td>
			<td nowrap><input name="uploadedfile" type="file" /> </td>
		</tr>
                <tr>
                   <td>    
                    <a href="#" onclick="document.frmUpload.submit();document.getElementById('table').style.display='none';alert('Đã đính kèm hình ảnh cho thực đơn');">Đính kèm hình ảnh</a>
                    <td>
                </tr>        
	</table>
