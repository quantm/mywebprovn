...
<div class="language">
<a title="" href="http://myweb.pro.vn/ebook/en/" class="brand animated fadeInDown"> 
...
<li class="dropdown" style="width:auto">			
	...
	<i class="fa fa-sign-in fa-1x"></i> Sign in
	</a>
</li>

<li class="dropdown">
	<a class="item_link" href="#modal_register" data-toggle="modal">
	<i class="fa fa-check-square-o fa-1x"></i> Sign up
	</a>
</li>					
<?php endif;?>
<?php if($user_data != "-1"):?>
