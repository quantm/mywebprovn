...
$("#addVdictOnYourWeb").tooltip({
title:"từ điển này có thể được di chuyển cho tiện việc tra cứu bằng cách rê chuột trái",
placement:"top"
})
$(".related li").tooltip({
...
$(".text_guide")
	.html("<img width='32px' height='32px' src='/images/false.png'/> : bạn làm sai</br> <img width='32px' height='32px' src='/images/true.png'> : bạn làm đúng<br-/> <span style='color:red'></br>Click vào chữ <font color=blue>true</font> để xem giải thích về đáp án của mỗi câu</span>")
	.attr('style','margin-top:175px;margin-left:145%')
