...
$('.item-page h1').next().append('<input id="btn_read_online" style="margin-left:50%!important" data-type="read" type="button" class="btn btn-info btn_download" value="Đọc online"> <input data-type="download" type="button" class="btn btn-info btn_download" value="Tải về"><input type="button" class="btn btn-info btn-add-book" value="Thêm vào thư viện">')		
