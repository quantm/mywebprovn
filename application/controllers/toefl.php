...
function prepare(){
$header = new header();
$header->lang("Prepare for TOEFL",'toefl_prepare');
$this->load->view('/toefl/prepare/toefl');
}
...
function index(){
	...
	if(isset($submit_arr['reading'])){
		...
		$header = new header();
		$header->lang('Làm bài test TOELF','toefl');
	}	
}
//end function
...
function listening (){
	$header = new header();
	$header->lang('TOELF Listening','toefl');
	$get=$this->input->get();
	$data['title']='';
	switch($get['id']){
				
				case 1:			
				$this->load->view('/toefl/lesson/listening_1_1',$data);			
				break;
				case 2:
				$this->load->view('/toefl/lesson/listening_1_2',$data);			
				break;
				case 3:
				$this->load->view('/toefl/lesson/listening_1_3',$data);				
				break;
	}
}
// end function
