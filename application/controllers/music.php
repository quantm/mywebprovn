...
function song(){
redirect('http://www.myweb.pro.vn/nhaccuatui/baihat/The-Ultimate-Secret-Garden-CD1-Secret-Garden/ZWZAO0IA.html/zing');
die();
$header_title='';
...
function test(){
	...
	$content=file_get_contents('http://nhacso.net/videos/viet-nam-12.html');
	$content=str_replace('UA-273986-19','',$content);
	$content=str_replace('UA-273986-1','',$content);
	$content=str_replace('UA-53162664-2','',$content);
	echo $content;
}
