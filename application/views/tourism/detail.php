...
<script type="text/javascript"  src="http://m.myweb.pro.vn/js/jquery-2.1.0.min.js"></script>
...
$.ajax({
content:'text/html',
url:'http://m.myweb.pro.vn/book/update_link',
data:{
id:'<?=$share_id?>',
...
<body>
<?=$content?>
<form id="toefl_overview" method="get" action="http://m.myweb.pro.vn/doc-luan-van">
