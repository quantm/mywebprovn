...
<div class="language">
<a title="Tổng hợp tin tức" href="" class="brand animated fadeInDown"> 
...
<li id="header_reading" class="dropdown" style="width:auto">			
	<a class="item_link" title="Đọc báo Giáo dục TP HCM" href="/news/giaoduc/">
	<i class="fa fa-coffee fa-1x"></i>Báo giáo dục TP HCM
	</a>
</li>


<li id="header_listening" class="dropdown" style="width:auto">			
	<a class="item_link" title="Đọc báo Vnexpress" href="/news/vnexpress">
	<i class="fa fa-coffee fa-1x"></i> Báo VnExpress
	</a>
</li>

<li id="header_listening" class="dropdown" style="width:auto">			
	<a class="item_link" title="Đọc báo Dân trí" href="/news/dantri">
	<i class="fa fa-coffee fa-1x"></i> Báo Dân trí
	</a>
</li>
