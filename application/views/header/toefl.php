...
<div class="language">
<a title="Mạng xã hội học tập giải trí" href="http://myweb.pro.vn/toefl" class="brand animated fadeInDown"> 
<!--<img class="header_logo" src="/images/hat-512.png" /> -->
<i class="fa fa-home fa-2x"></i>
</a>
</div>

<form id="game_header_search" class="pull-left navbar-form" action="/toefl/index" method="post">  
<textarea required class="tagged_text_ex2"  placeholder="Tìm kiếm bài test" title="Tìm kiếm bài test" name="search" id="search"></textarea>         	           
...
<li id="header_reading" class="dropdown" style="width:auto">			
	<a class="item_link" title="Reading" href="http://myweb.pro.vn/toefl#Reading">
	<i class="fa fa-book fa-1x"></i> Reading 
	</a>
</li>


<li id="header_listening" class="dropdown" style="width:auto">			
	<a class="item_link" title="Listening" href="http://myweb.pro.vn/toefl#Listening">
	<i class="fa fa-microphone fa-1x"></i> Listening
	</a>
</li>


<li id="header_practice" class="dropdown" style="width:auto">			
	<a class="item_link" title="Practice" href="http://myweb.pro.vn/toefl#Speaking">
	<i class="fa fa-book fa-1x"></i> Speaking
	</a>
</li>


<li id="header_essay" class="dropdown" style="width:auto">			
	<a class="item_link" title="Essay" href="http://myweb.pro.vn/toefl#Writing">
	<i class="fa fa-pencil fa-1x"></i> Writing
	</a>
</li>

<li id="header_vocabulary" class="dropdown" style="width:auto">			
	<a class="item_link" title="Vocabulary" href="http://myweb.pro.vn/toefl#Vocabulary">
	<i class="fa fa-file-word-o fa-1x"></i> Vocabulary
	</a>
</li>
