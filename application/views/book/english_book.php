      ...
      <div class="shelf_center column">
		...
		<div class="book">
            ...
            <div class="cover" style="margin-left:-45px;">
				<a href="/read-book?id=<?=$key_top['id']?>"  title='<?=$key_top['name']?>' target="_new">
	  ...
	  <div class="shelf_center column">
        <div class="wrapper">
          <div class="book">
            ...
            <div class="cover" style="margin-left:-45px;">
			<a href="/read-book?id=<?=$key['ID']?>" title='<?=$key['NAME']?>' target="_new">
      ...
      <div class="shelf_center column">
        <div class="wrapper">
          <div class="book">
            ...
            <div class="cover" style="margin-left:-45px;">
			<a href="/read-book?id=<?=$key['ID']?>" title='<?=$key['NAME']?>' target="_new">
			<img src="<?=$key['THUMBS']?>" alt="<?=$key['NAME']?>" width="100" height="130" /></a>
			</div>
		  </div>
        </div>
      </div>
...
<div class="shelf_container last">
      <div class="shelf_center column">
       <div class="wrapper">
	   <div style="border:1px solid #990000;padding-left:20px;margin:0 0 10px 0;height:180px"></div>
      </div><!--/ wrapper -->
      </div><!--/shelf_center column-->
      <div class="shelf_left column">&nbsp;</div>
      <div class="shelf_right column">&nbsp;</div>
