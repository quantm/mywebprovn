...
<meta property="og:description" content="Tủ sách mở rộng tâm hồn - <?=$book_title?>" />
<meta property="og:url" content="http://myweb.pro.vn/doc-sach?id=<?=$share_id?>" />
<meta name="description" content="Tủ sách mở rộng tâm hồn - <?=$book_title?>" />
...
<!--#if !(MOZCENTRAL || CHROME || MINIFIED)-->
    <script src="/js/pdf/ompatibility.js"></script>
<!--#endif-->
...
<!--#if !PRODUCTION-->
    <script src="/js/pdf/ui_utils.js"></script>
    <script src="/js/pdf/default_preferences.js"></script>
    <script src="/js/pdf/preferences.js"></script>
    <script src="/js/pdf/download_manager.js"></script>
    <script src="/js/pdf/view_history.js"></script>
    <script src="/js/pdf/pdf_rendering_queue.js"></script>
    <script src="/js/pdf/pdf_page_view.js"></script>
    <script src="/js/pdf/text_layer_builder.js"></script>
    <script src="/js/pdf/annotations_layer_builder.js"></script>
    <script src="/js/pdf/pdf_viewer.js"></script>
    <script src="/js/pdf/pdf_thumbnail_view.js"></script>
    <script src="/js/pdf/pdf_thumbnail_viewer.js"></script>
    <script src="/js/pdf/pdf_outline_view.js"></script>
    <script src="/js/pdf/pdf_attachment_view.js"></script>
    <script src="/js/pdf/pdf_find_bar.js"></script>
    <script src="/js/pdf/pdf_find_controller.js"></script>
    <script src="/js/pdf/pdf_history.js"></script>
    <script src="/js/pdf/secondary_toolbar.js"></script>
    <script src="/js/pdf/presentation_mode.js"></script>
    <script src="/js/pdf/grab_to_pan.js"></script>
    <script src="/js/pdf/hand_tool.js"></script>
    <script src="/js/pdf/overlay_manager.js"></script>
    <script src="/js/pdf/password_prompt.js"></script>
    <script src="/js/pdf/document_properties.js"></script>
<!--#endif-->

<!--#if !MINIFIED -->
    <script src="/js/pdf/debugger.js"></script>
...
$(document).ready(function(){	
	//header top logo
	$('.navbar-inner')
		.append('<img src="/images/lotus-pink.png" class="header_lotus">')
	//end
})
...
<!--#endif-->
  ...
  <body tabindex="1" class="loadingInProgress">
      <!-- left image --->
	  <img id="hinh_phat_a_di_da" style="display:none" src="http://myweb.pro.vn/images/background/hinh_phat_a_di_da.gif" alt="NAM MÔ A DI ĐÀ PHẬT"/>
	  <!--/-->
	  <!-- start social like -->
	<div class="social_link">
	<div class="fb-share-button" data-layout="button_count" data-width="200px" data-height="100px"   data-href="http://myweb.pro.vn/doc-sach?id=<?=$share_id?>"></div>
