...
<link rel="stylesheet" href="http://xahoihoctap.net.vn/css/pdf_viewer.css"/>
...
#toolbarViewer {
--background-image: linear-gradient(to bottom, #E8E8E8, #3D4556)!important;
}
#vdict_iframe {
	width: 100%; 
	height: 555px; 
...
#addVdictOnYourWeb{
	position:fixed;
	width: 32%;
	border: 2px solid rgb(69, 152, 228);
	padding: 2px;
...
<!--#if !(MOZCENTRAL || CHROME || MINIFIED)-->
    <script src="http://myweb.pro.vn/js/pdf/compatibility.js"></script>
<!--#endif-->

<!--#if !PRODUCTION-->
    <script src="http://myweb.pro.vn/external/webL10n/l10n.js"></script>
<!--#endif-->

<!--#if !PRODUCTION-->
    <script src="http://myweb.pro.vn/src/shared/util.js"></script>
    <script src="http://myweb.pro.vn/src/display/api.js"></script>
    <script src="http://myweb.pro.vn/src/display/metadata.js"></script>
    <script src="http://myweb.pro.vn/src/display/canvas.js"></script>
    <script src="http://myweb.pro.vn/src/display/webgl.js"></script>
    <script src="http://myweb.pro.vn/src/display/pattern_helper.js"></script>
    <script src="http://myweb.pro.vn/src/display/font_loader.js"></script>
    <script src="http://myweb.pro.vn/src/display/annotation_helper.js"></script>
    <script>PDFJS.workerSrc = 'http://myweb.pro.vn/src/worker_loader.js';</script>
<!--#endif-->
...
<!--#if !PRODUCTION-->
    <script src="http://myweb.pro.vn/js/pdf/ui_utils.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/default_preferences.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/preferences.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/download_manager.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/view_history.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/pdf_rendering_queue.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/pdf_page_view.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/text_layer_builder.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/annotations_layer_builder.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/pdf_viewer.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/pdf_thumbnail_view.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/pdf_thumbnail_viewer.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/pdf_outline_view.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/pdf_attachment_view.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/pdf_find_bar.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/pdf_find_controller.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/pdf_history.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/secondary_toolbar.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/presentation_mode.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/grab_to_pan.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/hand_tool.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/overlay_manager.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/password_prompt.js"></script>
    <script src="http://myweb.pro.vn/js/pdf/document_properties.js"></script>
<!--#endif-->

<!--#if !MINIFIED -->
    <script src="http://myweb.pro.vn/js/pdf/debugger.js"></script>
	<script type="text/javascript"  src="http://myweb.pro.vn/js/jquery-2.1.0.min.js"></script>
	<script type="text/javascript" src="http://myweb.pro.vn/js/vdict.js"></script>
	...
	window.onload=function(){
		...
		$('#demo_lookup_dict').click(function(){
			$('#close_video,#read_book_lookup_dictionay').show('slow')
			$('#read_book_lookup_dictionay').attr('src','https://www.youtube.com/embed/cgPq1wXaMJs?autoplay=1')
		})

		$('#close_video').click(function(){
			$('#read_book_lookup_dictionay').hide('slow')
		})
		...
		$('#download').click(function(){
			var ads_href=$('.ads_right a')[0]	
				  window.open(ads_href,'_blank')
		})
	}
	</script>
	<script type='text/javascript'>
...
PDFJS.imageResourcesPath = 'http://myweb.pro.vn/images/pdf/';
  PDFJS.workerSrc = 'http://myweb.pro.vn/js/pdf/pdf.worker.js';
  PDFJS.cMapUrl = 'http://myweb.pro.vn/pdf/cmaps/';
...
<!--#endif-->
  ...
  <body tabindex="1" class="loadingInProgress">
   ...
   <button type="button" id="close_video" class="btn btn-primary" style="display:none;margin-left:5px;width:60px;margin-top:0px" data-dismiss="modal">Đóng</button>
   <iframe id="read_book_lookup_dictionay" width="875" height="545" frameborder="0" allowfullscreen></iframe>
   <div id='dict_note'>
   Nếu các bạn tham khảo sách Anh ngữ các bạn có thể tra từ điển bằng cách: 
   <div style="clear:both"></div>
   <ul>
	<li>1. Click đôi vào từ muốn tra</li>
	<li>2. Bôi đen từ (hoặc cụm từ) và nhấn tổ hợp phím Ctr-Shift-Alt</li>
   </ul>
   <p id="demo_lookup_dict"> Xem demo</p>
   <p id="close_announcement">Đóng thông báo này</p>
   </div>
	-->
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button value="Tải về" id="download" class="btn btn-danger" title="Tải về" tabindex="34" data-l10n-id="download"> 
                  <span data-l10n-id="download_label">Tải về</span>
                </button>
                <!-- <div class="toolbarButtonSpacer"></div> -->
