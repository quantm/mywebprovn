...
$("cmd li").each(function(value,index){
ins_db_title.push($(this).find('.titga').html())
ins_db_thumbs.push($(this).find('img').attr('src'))
ins_db_desc.push($(this).next().find('.desc').html())
ins_db_link.push($(this).find('.titga').attr('href'))
$.ajax({
content:'text/html',
type:'get',
url:'http://myweb.pro.vn/book/get_doc',
data:{
...
<form id="get_page" action="http://myweb.pro.vn/book/get_doc_server/">
