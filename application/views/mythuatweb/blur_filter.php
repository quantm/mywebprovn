...
<meta property="og:image" content="http://myweb.pro.vn/images/photoshop/4.1.jpg" />
<style>
.social_shared {
...
$(document)
	...
	$('#xem_phim_huong_dan').mouseover(function(){
		...
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/yWMjEuBhqJo')
	})
		$('#xem_phim_minh_hoa').mouseover(function(){
		$('#modal_video .modal-header-title').html('Photoshop - Minh họa');
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/6CTeXI9Kt58')
	})
	//end
...
<div class="fb-like" data-href="http://myweb.pro.vn/photoshop/blur-filter" data-layout="box_count" data-action="like" data-show-faces="true" data-share="true"></div>
...
Ứng dụng các kiến thức đã học, kết hợp nhóm bộ lọc Blur thực hiện lại theo mẫu.
...
<img src='http://myweb.pro.vn/images/photoshop/4.1.jpg' alt='Photoshop - Channel and Blending Mode'/>

<p style="color:blue;cursor:pointer;margin-top: 1%;">
	<a  href="https://www.mediafire.com/?608usv72gscsua7" target="_new">Click để lấy file ảnh bài tập</a>
</p>
<p id="output_data" >
...
<ul>
<li>Áp dụng các thao tác với vùng chọn và đối tượng đã học. </li>
<li>Các lệnh hiệu chỉnh màu.</li>
<li>Các chức năng text và chế độ mặt nạ (Mask)</li>
<li>Các hiệu ứng Layer Styles.</li>
<li>Nhóm bộ lọc Filter\ Blur (Motion Blur)</li>
</ul>

<p style="color:red;font-weight:bold">Hướng dẫn:</p>
<div style="clear:both"></div>
<ul class="huong_dan">
<li><span>Nền :</span>  Sử dụng mẫu tô pattern, kết hợp mặt nạ</li>
<li><span>Mảng màu xanh : </span> Tạo vùng chọn và tô màu đơn (xanh)</li>
<li><span>Vệt nhòe bên dưới chiếc xe và Text: Motion Blur :  </span>Motion Blur</li>
<li><span>Vòng tròn trên đèn xe: </span>Tăng contrast</li>
<li><span>Text: </span>Nhập text -> Layer Style</li>
</ul>

<p style="color:red;font-weight:bold">Các bài khác:</p>
<div style="clear:both"></div>
<ul class="huong_dan">
<li><a href="/photoshop/blur-filter?id=2">Bộ lọc Blur bài 2</a></li>
