<meta charset="UTF-8"/>
<meta name="description" content="Học photoshop - hiệu chỉnh ảnh màu"/>
<meta property="og:image" content="http://myweb.pro.vn/images/photoshop/2.3.jpg" />
<style>
.social_shared {
...
$(document)
	...
	$('#xem_phim_huong_dan').mouseover(function(){
		$('#modal_video .modal-header-title').html('Photoshop - Hướng dẫn hiệu chỉnh ảnh màu');
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/OwJCmjzyIVU')
	})

		$('#xem_phim_minh_hoa').mouseover(function(){
		$('#modal_video .modal-header-title').html('Photoshop - Minh họa hiệu chỉnh ảnh màu');
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/oyZkeheTOBk')
	})
	//end
...
<div class="fb-like" data-href="http://myweb.pro.vn/photoshop/hieu-chinh-anh-mau?id=3" data-layout="box_count" data-action="like" data-show-faces="true" data-share="true"></div>
...
Áp dụng các kỹ thuật đã học trong chương trình, hiệu chỉnh ảnh màu theo mẫu.
...
<img src='http://myweb.pro.vn/images/photoshop/2.3.jpg' alt='Photoshop - Hiệu chỉnh ảnh màu'/>

<p style="color:blue;cursor:pointer;margin-top: 1%;">
	<a  href="https://www.mediafire.com/?7oz81a6hx3f8eda" target="_new">Click để lấy file ảnh bài tập</a>
</p>
<p id="output_data" >
	<a href="https://www.mediafire.com/?7oz81a6hx3f8eda" target="_new">Click để lấy file kết quả</a>
</p>
...
<div style="clear:both"></div>
<ul class="huong_dan">
<li><span>Ảnh dư Flash: </span>  Duplicate Layer -> Chọn chế độ hòa trộn là Miltiply -> Che mặt nạ phần tối xung quanh.</li>
<li><span>Giảm nhiễu:</span> Duplicate Layer -> Filter/Blur/ Gaussian Blur = 5 -> Chọn chế độ hòa trộn là Screen.</li>
<li><span>Ảnh thiếu sáng:  </span> Duplicate Layer -> Chọn chế độ hòa trộn là Screen -> Tiếp tục Duplicate cho đến khi đủ sáng.</li>
<li><span>Ảnh bị ngược sáng: </span>
		Duplicate Layer -> Chọn chế độ hòa trộn là Screen -> Che mặt nạ phần sáng xung quanh -> Duplicate cho đến khi đủ sáng -> Giảm Opacity (nếu cần).
</li>
<li><span>Khử mắt đỏ:</span> 
	Cách 1: Dùng công cụ Red Eye kéo rê chọn vùng mắt đỏ. Cách 2: Chọn vùng mắt đỏ -> Chọn kênh Blue -> Copy và chọn kênh Red -> Paste
</li>
</ul>
