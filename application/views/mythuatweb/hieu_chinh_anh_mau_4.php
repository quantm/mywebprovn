...
<meta property="og:image" content="http://myweb.pro.vn/images/photoshop/2.4.jpg" />
<style>
.social_shared {
...
$(document)
	...
	$('#xem_phim_huong_dan').mouseover(function(){
		...
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/L-SibRuB_Vg')
	})

		$('#xem_phim_minh_hoa').mouseover(function(){
		$('#modal_video .modal-header-title').html('Photoshop - Minh họa hiệu chỉnh ảnh màu');
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/YN2jTHP3kEg')
	})
	//end
...
<div class="fb-like" data-href="http://myweb.pro.vn/photoshop/hieu-chinh-anh-mau?id=4" data-layout="box_count" data-action="like" data-show-faces="true" data-share="true"></div>
...
<img src='http://myweb.pro.vn/images/photoshop/2.4.jpg' alt='Photoshop - Hiệu chỉnh ảnh màu'/>

<p style="color:blue;cursor:pointer;margin-top: 1%;">
	<a  href="https://www.mediafire.com/?mo7gnsukv99c4tx" target="_new">Click để lấy file ảnh bài tập</a>
</p>
<p id="output_data" >
...
<li>Áp dụng bộ lọc hỗ trợ Neat Image 4.0 Pro Plus Edition</li>
</ul>

<p style="color:red;font-weight:bold">Hướng dẫn:</p>
<div style="clear:both"></div>
<ul class="huong_dan">
<li><span>Chỉnh mịn da: </span>  Neat Image</li>
<li><span>Gỡ bỏ bọng mắt: </span> Dùng công cụ Patch Tool</li>
<li><span>Vẽ thêm mi mắt:  </span> Dùng công cụ Dodge Tool</li>
<li><span>Tô má hồng: </span>Tạo Layer mới -> Dùng cọ Brush màu hồng, giảm Opacity -> Tô lên vùng má</li>
<li><span>Tô màu mắt:</span>  Dùng cọ Brush tô tương tự má hồng hoặc đổi màu da.</li>
<li><span>Các tia sáng trên nhẫn và bông tai: </span>  Dùng cọ Brush </li>
</ul>
