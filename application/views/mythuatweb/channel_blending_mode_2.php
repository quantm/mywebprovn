...
<meta property="og:image" content="http://myweb.pro.vn/images/photoshop/blending_mode_2.jpg" />
<style>
.social_shared {
...
$(document)
	...
	$('#xem_phim_huong_dan').mouseover(function(){
		...
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/KcI9frc24jI')
	})
		$('#xem_phim_minh_hoa').mouseover(function(){
		$('#modal_video .modal-header-title').html('Photoshop - Minh họa');
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/xUnYMs7PHAw')
	})
	//end
...
<div class="fb-like" data-href="http://myweb.pro.vn/photoshop/chanel-blending-mode?id=2" data-layout="box_count" data-action="like" data-show-faces="true" data-share="true"></div>
...
Ứng dụng các kiến thức đã học, kết hợp Channel và các chế độ Blending Mode thực hiện lại theo mẫu.
...
<img src='http://myweb.pro.vn/images/photoshop/blending_mode_2.jpg' alt='Photoshop - Channel and Blending Mode'/>

<p style="color:blue;cursor:pointer;margin-top: 1%;">
	<a  href="https://www.mediafire.com/?494jjldecfhj84p" target="_new">Click để lấy file ảnh bài tập</a>
</p>
<p id="output_data" >
	<a href="https://www.mediafire.com/?494jjldecfhj84p" target="_new">Click để lấy file kết quả</a>
</p>
...
<div style="clear:both"></div>
<ul class="huong_dan">
<li>Xóa nền trắng của file Begin</li>
<li>Tạo file mới bằng kích thước file “Final”</li>
<li>Tô chuyển sắc cho lớp nền</li>
<li>Lần lượt cắt từng đối tượng sang file mới</li>
<li><span>Chiếc cặp gỗ:</span>  Cho đổ bóng “Drop Shadow”</li>
<li><span>Đĩa thức ăn: </span>Che mặt nạ dạng chuyển sắc</li>
<li><span>Quả lê:</span> Giảm Opacity -> Che mặt nạ phần bên trong quả lê (phần tiếp giáp vành đĩa)</li>
<li><span>Chiếc tách: </span> Dùng chế độ hòa trộn “Overlay”</li>
<li><span>Chữ “N”: </span> Đặt layer hoa quả ngay bên trên Layer “N”  -> Group hai layer này lại -> Đứng tại layer hoa quả, dùng chế độ hòa trộn là Overlay.</li>
<li><span>Text: </span> 
	Nhập Text, tạo một layer mới -> Vẽ một đường line đặt bên dưới Text -> Link hai layer Text và đường line -> Ctrl + T -> Xoay nghiêng như mẫu.
</li>
</ul>
...
<li><a href="/photoshop/chanel-blending-mode">Channel and Blending Mode bài 1</a></li>
</ul>
