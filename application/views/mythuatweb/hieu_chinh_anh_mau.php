...
<meta property="og:image" content="http://myweb.pro.vn/images/photoshop/2.1.1.jpg" />
<style>
.social_shared {
...
$(document)
	...
	$('#xem_phim_huong_dan').mouseover(function(){
		...
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/c9IHZvPzmUg')
	})
		$('#xem_phim_minh_hoa').mouseover(function(){
		$('#modal_video .modal-header-title').html('Photoshop - Minh họa hiệu chỉnh ảnh màu');
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/XwbxX6Wruyg')
	})
	//end
...
<div class="fb-like" data-href="http://myweb.pro.vn/photoshop/hieu-chinh-anh-mau" data-layout="box_count" data-action="like" data-show-faces="true" data-share="true"></div>
...
<img src='http://myweb.pro.vn/images/photoshop/2.1.1.jpg' alt='Photoshop - Hiệu chỉnh ảnh màu'/>

<p style="color:blue;cursor:pointer;margin-top: 1%;">
	<a  href=" https://www.mediafire.com/?v885ew4bk2wsp33" target="_new">Click để lấy file ảnh bài tập</a>
</p>
<p id="output_data" >
	<a href=" https://www.mediafire.com/?v885ew4bk2wsp33" target="_new">Click để lấy file kết quả</a>
</p>
...
<div style="clear:both"></div>
<ul class="huong_dan">
<li><span>Da :</span> Hiệu chỉnh nhiều lần với nhiều lệnh.</li>
<li><span>Tóc :</span>  Lấy màu da + giảm bớt sắc độ (giá trị saturate) + Tăng constrast</li>
<li><span>Môi : </span> Tạo vùng chọn -> Lưu vùng chọn -> Hiệu chỉnh màu.</li>
<li><span>Chân mày: </span>Làm đậm chân mày với công cụ Burn</li>
<li><span>Áo :</span> Tạo vùng chọn -> Lưu vùng chọn -> Hiệu chỉnh màu</li>
<li><span>Nền : </span>Chọn vùng chọn xung quanh cô gái (feather cao) -> Invert selection -> Filter/ Blur/ Motion Blur (Làm nhòe dạng chuyển động). Đưa hình nền hoa hồng vào -> dùng chế độ hòa trộn -> giảm opacity, che mặt nạ ...</span></li>
</ul>
