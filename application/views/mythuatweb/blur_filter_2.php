...
<meta property="og:image" content="http://myweb.pro.vn/images/photoshop/4.2.jpg" />
<style>
.social_shared {
...
Ứng dụng các kiến thức đã học, kết hợp nhóm bộ lọc Blur và Texture thực hiện lại theo mẫu.
...
<img src='http://myweb.pro.vn/images/photoshop/4.2.jpg' alt='Photoshop - Channel and Blending Mode'/>
...
<li>Nhóm bộ lọc Filter\ Texture\ Texturize (Canvas)</li>
</ul>
...
<ul ><span>Nền :</span>
	<li>Filter/ Blur/ motion Blur</li>
	<li>Filter/ texture/ Texturizer (canvas)</li>
</ul>

<ul ><span>Cô gái :</span>
	<li>Lọc hình bằng Extract hoặc KnockOut</li>
	<li>Chỉnh màu môi, màu áo, má hồng</li>
	<li>Tạo tia lóe sáng bằng cọ Brush</li>
</ul>

<ul ><span>Mèo con :</span>
	<li>Lọc hình </li>
	<li>Bổ sung tia sáng cho máy ảnh</li>
	<li>Tạo tia lóe sáng bằng cọ Brush</li>
</ul>

<ul ><span>Chùm sáng :</span>
	<li>Chọn một vùng chọn tại vị trí chùm sáng -> Tô chuyển sắc từ vàng cam sang màu trong suốt -> Che thêm mặt nạ.</li>
</ul>

<ul ><span>Biểu tượng suy nghĩ :</span>
	<li>Sử dụng custom shape .</li>
	<li>Nhập text “Funny Cat” </li>
	<li>Layer Style + Giảm Fill = 0</li>
</ul>
...
<div style="clear:both"></div>
<ul class="huong_dan">
<li><a href="/photoshop/blur-filter">Bộ lọc blur bài 1</a></li>
