...
<meta property="og:image" content="http://myweb.pro.vn/images/photoshop/2.2.jpg" />
<style>
.social_shared {
...
$(document)
	...
	$('#xem_phim_huong_dan').mouseover(function(){
		...
		$("#modal_video").find('iframe').attr('src','https://www.youtube.com/embed/mko9RMSX-CU')
	})
	//end
...
<div class="fb-like" data-href="http://myweb.pro.vn/photoshop/hieu-chinh-anh-mau?id=2" data-layout="box_count" data-action="like" data-show-faces="true" data-share="true"></div>
...
<img src='http://myweb.pro.vn/images/photoshop/2.2.jpg' alt='Photoshop - Hiệu chỉnh ảnh màu'/>

<p style="color:blue;cursor:pointer;margin-top: 1%;">
	<a  href="https://www.mediafire.com/?mmk7ub5b5fte58h" target="_new">Click để lấy file ảnh bài tập</a>
</p>
<p id="output_data" >
	<a href="http://www.mediafire.com/download/v885ew4bk2wsp33/bai+tap+hieu+chinh+anh+mau.rar" target="_new">Click để lấy file kết quả</a>
</p>
...
<div style="clear:both"></div>
<ul class="huong_dan">
<li><span>Xóa chữ trên cánh tay: </span> Dùng công cụ Patch Tool</li>
<li><span>Làm mịn da: </span>  Dùng lệnh “Surface Blur” hoặc Neat Image</li>
<li><span>Môi : </span> Chọn vùng bằng công cụ Pen -> Lưu vùng chọn -> Chuyển màu bằng một trong các công cụ hiệu chỉnh màu.</li>
<li><span>Má hồng: </span>Tạo một layer mới -> Dùng cọ Brush tô</li>
<li><span>Mí mắt:</span> Chọn vùng -> Chỉnh màu</li>
<li><span>Áo : </span>Chọn vùng -> Chỉnh màu</span></li>
<li>Merge các Layer lại -> Kéo ghép vào khung tranh</li>
</ul>
