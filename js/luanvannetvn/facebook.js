        ...
        FB.api("/me",
            function (profile_response) {
                if (profile_response && !profile_response.error ) {                                                            
                    ...
                    $.ajax({
                        type: 'GET',
                        url: 'http://myweb.pro.vn/user/facebook/',
                        data: {
                        ...
                        $(".list_chat").show();
							...
							//$('body').append('<form action="http://myweb.pro.vn/download/pdf" target="_new" method="post" id="pdf_download"><input type="hidden" name="id" id="id" value='+book_id+'><input type="hidden" name="csrf_test_name" id="csrf_test_name" value='+$('#csrf_test_name').val()+'></form>')				
							//$("#pdf_download").submit();
							//window.open('http://myweb.pro.vn/download/pdf?id='+book_id,'_new');
                        },
