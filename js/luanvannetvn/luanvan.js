...
function reset_ui_action (){
	...
	if($('body').find('#obj1').length){
		...
		$('.fb-share-button').addClass('fb_iframe_widget_obj_1')	
	...
	if($('base').attr('href')=='http://luanvan365.com/'){	
		...
		$('.adv_ants_header').addClass('adv_ants_header_luanvan_365')//fix header advertisement UI
		$('#content').addClass('wrapper_luan_van_365')//fix header advertisement UI
	...
	if($('base').attr('href')=='http://timtailieu.vn/'){
		...
		if($('#obj1').length=='1'){
				$('.btn-relevant-docs').addClass('btn-relevant-docs-obj1-timtailieuvn')
				$('.btn-download-guide')
				.removeClass('btn-download-guide-obj1-onload')
	...
	if($('base').attr('href')=='http://doc.edu.vn/'){
		...
		if($('#obj1').length=='0'){
				$('.btn-download-guide')
				.addClass('obj2-zbook-vn')
		}
		
	}
	if($('base').attr('href')=='http://zbook.vn/'){
		$('body').addClass('body_doc_edu_vn')
		if($('#obj1').length=='1'){
				$('.btn-download-guide')
				.removeClass('btn-download-guide-obj1-onload')
