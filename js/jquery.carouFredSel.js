...
if (crsl.upDateOnWindowResize) {
   ...
   var width_body = $('#sliderhome').width();
   var num_slide_city = Math.floor(width_body/250);
   //var num_left_search = Math.floor((width_body - 800)/2);
   //console.log(num_slide_city);
   $('.main_list_slider .image_list_slider img').css('width', width_body + 'px');
   //$('.box_search_top').css('left', num_left_search + 'px');
   
   /* Slider Home page */
   if($('#list_slider').length){
   	 $('#list_slider').carouFredSel({
      auto: {
         play : true,
         pauseDuration : 4000
      },
    ...
    /* Slider home city */
    if($('#slider-hotel-city').length){
    	$('#slider-hotel-city').carouFredSel({
	      auto: {
	         play : true,
	         pauseDuration : 10000
	      },
	      scroll : {
	         items           : num_slide_city,
	         fx              : "easeOutBounce",
	         duration        : 700,
	         pauseOnHover    : true
	     },
	     prev    : {
	         button  : "#list_city_prev",
	         key     : "left"
	     },
	         next    : {
	         button  : "#list_city_next",
	         key     : "right"
	     }
	    });
    }
    
    /*slider location related*/
    if( $('#slide_post_location').length){
    	   $('#slide_post_location').carouFredSel({
	      auto: {
	         play : false,
	         pauseDuration : 10000
	      },
    ...
    /* Slider Home page */
    if($('#slider-hot-promo').length){
    	 $('#slider-hot-promo').carouFredSel({
	      auto: {
	         play : true,
	         pauseDuration : 10000
	      },
   ...
   $('.city_home_tab ul li a').click(function(){
      var type = parseInt($(this).attr('data-type'));
      if (type == 1) {
         $('#box_promo_home .arrow_down').addClass('noneshow');
         $('#box_promo_home .city_home_tab ul li a').removeClass('active');
      } else {
         $('#box_most_home .arrow_down').addClass('noneshow');
         $('#box_most_home .city_home_tab ul li a').removeClass('active');
      }

      $(this).addClass('active');
      $(this).parent().find('.arrow_down').removeClass('noneshow');
   });
