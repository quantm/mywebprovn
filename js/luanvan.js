...
//count
$("#globalheader div").append("<a style='float:right;margin-left:35%;position:absolute;pointer-events:none' href='#'>Tổng số luận văn : " +$('#total_rows').val()+"</a><a href='/home/about'></a>")
//end
