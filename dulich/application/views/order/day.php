                    ...
                    <tbody>
                        ...
                        echo $row['NAME']
                            ?></a></td>
                                ...
                                <td colspan="2" style="vertical-align: middle;width: 245px;">
                                    <?= $row['NOTES'] ?>
                                </td>
                            </tr>
                    ...
                    <tfoot>
                        ...
                        ['NAME']
                            ?></span>] body=[<table><tr><td valign=top>Email: <?php echo $value['EMAIL'] ?></td></tr><tr><td valign=top>Trai kỳ: <?php echo $value['VEGETARIAN_TYPE'] ?></td></tr><tr><td valign=top>Cách thanh toán: <?php echo $value['PAID_METHOD'] ?></td></tr></table>]"'><?php
                                                                               ...
                                                                               echo $value['NAME']
                            ?></a></td>
                                <td><input name='phone' id='phone' style="vertical-align: middle;width:85px;"  type='text' value='<?= $value['PHONE'] ?>'></input></td>
                                <td style="vertical-align: middle;width:120px;">
                                    <input type='text' name='address' id='address' style="vertical-align: middle;width:120px;" value='<?= $value['ADDRESS'] ?>'></input>
                                </td>
                                <td>
                                ...
                                <td >
                                    <input id="giogiao" style="vertical-align: middle;width: 55px;"  name="giogiao" type='text' value='<?= $value['DELIVERY_TIME'] ?>'/>
                                </td>
