...
function AUTONEWS ($url,$indexpage = "") 
{    
...
{ 
/*if (function_exists('file_get_contents')) {//check support function file_get_contents
   $ch = curl_init();
   ...
   var_dump($this->segments['path']);	
   $headers = "GET $destination HTTP/1.0\r\n";
   $headers .= "Host: ".$this->segments['host']."\r\n";
   ...
   $fp = fsockopen($this->segments['host'], $this->segments['port'], $err_no, $err_str, 10);
