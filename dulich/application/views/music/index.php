...
<body>
<!-- start header music search-->
<div class="music_header_search">
<style type="text/css">
@import url(//www.google.com/cse/api/branding.css);
</style>
<div class="cse-branding-bottom" style="background-color:transparent;color:#000000">
<div class="cse-branding-form">
<form action="http://myweb.pro.vn/music/index/" id="cse-search-box">
<div>
<input type="hidden" name="cx" value="partner-pub-1996742103012878:4593353084" />
<input type="hidden" name="ie" value="UTF-8" />
<input type="hidden" name="cof" value="FORID:10" />
<input placeholder="Tìm kiếm tùy chỉnh với Google" type="text" class="cse_textbox" name="q" size="55" />
